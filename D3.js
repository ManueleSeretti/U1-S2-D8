...
for (let i = 0; i < starWarsCharacters.length; i++) {
  characters = characters + starWarsCharacters[i].name + ", ";
}
...
if (crewMass <= 500) {
  ...
  console.log("DANGER! OVER ALERT: escape from ship now!");
}
...
*/
x = parseInt(Math.random() * starWarsCharacters.length);
console.log(starWarsCharacters[x]);
